...
def test_tracking_17_items_in_1_obj_1_frame(te: TrackingEvaluation, files_dir: Path) -> None:
    """."""
...
def test_tracking_18_items_in_1_obj_1_frame(te: TrackingEvaluation, files_dir: Path) -> None:
    """."""
...
def test_tracking_19_items_in_1_obj_1_frame(te: TrackingEvaluation, files_dir: Path) -> None:
    """."""
...
def test_track_id_negative_and_car(te: TrackingEvaluation, files_dir: Path) -> None:
    """."""
